...
local function showCommandGui(player)
	...
	local commands = {
		...
		"115 - !rail <plr|all|others|random|friends>",

		"--// Locked Commands \\--",
		"116 - !hang <plr|all|others|random|friends> [🔒]",
		"117 - !crucify <plr|all|others|random|friends> [🔒]",
		"118 - !guil <plr|all|others|random|friends> [🔒]",
		"119 - !hang2 <plr|all|others|random|friends> [🔒]",
		"120 - !woman <plr|all|others|random|friends> [RESTRICTED] [🔒]",
		"121 - !bang <plr1> [optional] <plr2> [RESTRICTED] [🔒]",

		"--// Restricted Commands \\--",
		"122 - !s <code> [RESTRICTED]",
		"123 - !jork <plr|all|others|random|friends> [RESTRICTED]",
		"124 - !polaria <plr|all|others|random|friends> [RESTRICTED]",
		"125 - !sens <plr|all|others|random|friends> [RESTRICTED]",
		"126 - !projhub <plr|all|others|random|friends> [RESTRICTED]",
		"127 - !hwl <plr|all|others|random|friends> [RESTRICTED]",
		"128 - !unhwl <plr|all|others|random|friends> [RESTRICTED]",
		"129 - !buildload <plr> <slot> [KAH ONLY] [RESTRICTED]",
		"130 - !buildremove <plr> <slot> [KAH ONLY] [RESTRICTED]",
		"131 - !exser <plr|all|others|random|friends> [RESTRICTED]",
		"132 - !legacychat [RESTRICTED]",
		"133 - !synapse <plr|all|others|random|friends> [RESTRICTED]",
		"134 - !nfchat [RESTRICTED]",
		"135 - !ls <plr|all|others|random|friends> <code> [RESTRICTED]",
		"136 - !stratosphere <plr|all|others|random|friends> [RESTRICTED]",
		"137 - !happyhub <plr|all|others|random|friends> [RESTRICTED]",
		"138 - !forceplace <plr|all|others|random|friends> <id> [RESTRICTED]",
		"139 - !adonis <plr> [RESTRICTED]",

		"--// Utility Commands \\--",
		"140 - !h <message>",
		"141 - !clr - Cleans the server of junk",
		"142 - !shutdown <reason> - Shuts the server down",
		"143 - !wls - View whitelisted users in current server",
		"144 - !plrlist - View current players in server",
		"145 - !bans - View banned players from the current server",
		"146 - !permbans - View permanently banned players across all servers",
		"147 - !restoremap - Generates the newest KAH map [LEGACY ONLY]",
		"148 - !hideobby - Hides the obby",
		"149 - !unhideobby - Unhides the obby",
		"150 - !unload - Unloads Vecxo Lite",
		"151 - !reloadscript - Unloads and Reloads Vecxo Lite",
		"152 - !gobby - Generates cool obby",
		"153 - !nukemap - Places tactical nukes everywhere",
		"154 - !serverprotection <true/false>",
		"155 - !antialt <true/false> - Kicks accounts younger than 2 days automatically",
		"156 - !antiloudnoise <true/false>",
		"157 - !cmdbar - Opens the command bar",
		"158 - !logs - Opens logs",
		"159 - !restart - Restarts the server and opens a new one",
		"160 - !exit - You leave za server :D",
		"161 - !info - Script/Server information",
		"162 - !ogmap - Re-generates 2013 OG KAG map",
		"163 - !spleef <value> <value2> - OG Spleef game",
		"164 - !loadmap - Loads a previously saved map",
		"165 - !savemap - Saves the current map",
		"166 - !antiskid - Loads an Anti Skid module [For Require games]",
		"167 - !baseplate - Creates and places a baseplate",
		"168 - !music <id>",
		"169 - !time <value>",
		"170 - !partmoving <true/false>",
		"171 - !pitch <value>",
		"172 - !volume <value>",
		"173 - !serverlock <true/false>"
	}
	...
	elseif cmd == "!kfc" then
		...
		if not game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("KFC") then
			...
			if success and sender.Character and sender.Character:FindFirstChild("HumanoidRootPart") then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ KFC failed to load: ".. fail)
			end
		else
			local building = game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("KFC"):Clone()
			building.PrimaryPart = building:FindFirstChild("Union")
	...
	elseif cmd == "!711" then
		...
		if not game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("7-11") then
			...
			if success and sender.Character and sender.Character:FindFirstChild("HumanoidRootPart") then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ 7-11 failed to load: ".. fail)
			end
		else
			local building = game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("7-11"):Clone()
			building.PrimaryPart = building:FindFirstChild("Door"):FindFirstChild("Left"):FindFirstChild("Part")
	...
	elseif cmd == "!mcdonalds" then
		...
		if not game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("McDonald's") then
			...
			if success and sender.Character and sender.Character:FindFirstChild("HumanoidRootPart") then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ McDonalds failed to load: ".. fail)
			end
		else
			local building = game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("McDonald's"):Clone()
			building.PrimaryPart = building:FindFirstChild("Floor")
	...
	elseif cmd == "!burgerking" then
		...
		if not game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("BurgerKing") then
			...
			if success and sender.Character and sender.Character:FindFirstChild("HumanoidRootPart") then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Burger King failed to load: ".. fail)
			end
		else
			local building = game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("BurgerKing"):Clone()
			building.PrimaryPart = building:FindFirstChild("Part")
	...
	elseif cmd == "!subway" then
		...
		if not game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("SubWay") then
			...
			if success and sender.Character and sender.Character:FindFirstChild("HumanoidRootPart") then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Subway failed to load: ".. fail)
			end
		else
			local building = game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("Subway"):Clone()
			building.PrimaryPart = building:FindFirstChild("Union")
...
createCmdBar()
	...
	elseif cmd == "!restart" then
		...
		if game.PlaceId == 14747334292 then
			...
			teleportService:TeleportToPrivateServer(game.PlaceId, code, game.Players:GetPlayers())
		end
		repeat task.wait(0.2) until #game.Players:GetPlayers() == 0
		running = false
		message:Destroy()
		while true do
			task.wait(0.2)
	...
	elseif cmd == "!log" then
		...
		for _, plr in pairs(targets) do
			...
			if executeEvent then
				local remoteId = tostring(executeEvent)
				if not _G.hookedRemotes[remoteId] then
					_G.hookedRemotes[remoteId] = executeEvent.OnServerEvent:Connect(function(player, ...)
						local args = {...}
						local logMessage = "✅ Execution Logged -\n" .. player.Name .. "\n" .. string.rep("-", 10) .. "\n"
						if #args > 0 then
							for i, arg in pairs(args) do
								logMessage = logMessage .. "Arg " .. i .. ": " .. tostring(arg) .. "\n"
							end
						else
							logMessage = logMessage .. "No arguments passed"
						end
						notify(sender, "[Remote Log]: ", logMessage, "")
					end)
	...
	elseif cmd == "!unlog" then
		handled = true
		if _G.hookedRemotes then
			for id, connection in pairs(_G.hookedRemotes) do
				connection:Disconnect()
			end
			_G.hookedRemotes = {}
			notifyv3(sender, "[Vecxo Lite]: ", "🛑 Stopped all execution logging")
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ No active execution logging to stop")
		end
	elseif cmd == "!clr" then
		handled = true
		...
		if desiredState == "true" then
			...
			for _, player in ipairs(Players:GetPlayers()) do
				if player.AccountAge < 2 then
					player:Kick("❌ Your account is too new to join this game (must be 2+ days old).")
			...
			notifyv3(sender, "[Vecxo Lite]:", "✅ Anti-alt enabled. Accounts younger than 2 days will be kicked.")
		elseif desiredState == "false" then
	...
	elseif cmd == "!backpack" then
		...
		for i, plr in ipairs(targets) do
			...
			scr.Enabled = true
			--	notifyv3(sender, "[Vecxo Lite]: ", "✅ "..plr.DisplayName.."'s backpack has been set to - "..args[3])
		end
