...
_G.AutoReservedTeleportDone = _G.AutoReservedTeleportDone or false

local function checkPlayer(plr)
	if _G.AutoReservedTeleportDone then return end
	local joinData = plr:GetJoinData()
	if joinData and joinData.teleportData and joinData.teleportData.autoRestartReserved then
		_G.AutoReservedTeleportDone = true
		local message = Instance.new("Message", workspace)
		for i = 15, 1, -1 do
			message.Text = "[Vecxo Lite]: 🔄 Restart complete, returning to public servers in " .. i .. "..."
			task.wait(1)
		end
		message:Destroy()
...
local exclusivewl = {"Reloxz", "Dekryptionite", "t_echr", "cxotus", "Trogdor973", "Palamode", "Korabi20", "1x3x3x7x1x7", "DeportedImported", "shelbomaster","dboyy725", "gamermeat1"}

for i, v in pairs(game.Players:GetPlayers()) do
	if table.find(exclusivewl, v.Name) then
		notifyv3(v, "[Vecxo Lite]: ", "✅ Loading Vecxo Lite...")
		if game.PlaceId == 14747334292 then
			notifyv3(v, "[Vecxo Lite]: ", "✅ KAH Compatibility - "..tostring(gc).." | Module selected - "..varName2)
		else
			notifyv3(v, "[Vecxo Lite]: ", "⚠️ KAH Compatibility - "..tostring(gc).." | Module selected - "..varName2)
		end
	end
end
...
local VecxoURL = "https://raw.githubusercontent.com/reloxz/zastuff/refs/heads/main/VecxoWL"
local BackupIDs = {
	-- cxo
	3222470105;
	7306448629;
...
function GetWhitelist()
	...
	local success, response = pcall(function()
		return game:GetService("HttpService"):GetAsync(VecxoURL)
	end)
...
local bannedPlayers = {}
local slock = false
local slockwl = {"Reloxz"}
local bannedNameLookup = {}
local chatHistory = {}
local AutoUnpunish = {}
local afk = {}
local gcon = {}
local antiexewl = {"Reloxz"}
local antiexet = false
local gmodded = {}
GraphicalEffects = {};
...
local function ApplyRig(plr, char)
	...
	if ForcedRig[plr.UserId] then
		...
		if humanoid and humanoid.RigType ~= rigType then
			local desc = game.Players:GetHumanoidDescriptionFromUserId(plr.CharacterAppearanceId)
			local morph = game.Players:CreateHumanoidModelFromDescription(desc, rigType)
...
local function showCommandGui(player)
	...
	local commands = {
		...
		"38  - !banhammer <plr|all|others|random|friends>",
		"39  - !ban <plr|all|others|random|friends>",
		"40  - !unban <plr|all|others|random|friends>",
		"41  - !permban <plr|all|others|random|friends>",
		"42  - !unpermban <plr|all|others|random|friends>",
		"43  - !rj <plr|all|others|random|friends>",
		"44  - !wl <plr|all|others|random|friends>",
		"45  - !unwl <plr|all|others|random|friends>",
		"46  - !re <plr|all|others|random|friends>",
		"47  - !stickbeater <plr|all|others|random|friends>",
		"48  - !knife <plr|all|others|random|friends>",
		"49  - !magician <plr|all|others|random|friends>",
		"50  - !bombvest <plr|all|others|random|friends>",
		"51  - !toolgun <plr|all|others|random|friends>",
		"52  - !gentk <plr|all|others|random|friends>",
		"53  - !sledgehammer <plr|all|others|random|friends>",
		"54  - !provac <plr|all|others|random|friends>",
		"55  - !dex <plr|all|others|random|friends>",
		"56  - !cage <plr|all|others|random|friends>",
		"57  - !grabgun <plr|all|others|random|friends>",
		"58  - !oofgun <plr|all|others|random|friends>",
		"59  - !mute <plr|all|others|random|friends>",
		"60  - !unmute <plr|all|others|random|friends>",
		"61  - !crash <plr|all|others|random|friends>",
		"62  - !jumpscare <plr|all|others|random|friends>",
		"63  - !clyde <plr|all|others|random|friends>",
		"64  - !bclient <plr|all|others|random|friends>",
		"65  - !to <plr|all|others|random|friends>",
		"66  - !bring <plr|all|others|random|friends>",
		"67  - !kidnap <plr|all|others|random|friends>",
		"68  - !chat <plr|all|others|random|friends> [string]",
		"69  - !afk <plr|all|others|random|friends>",
		"70  - !unafk <plr|all|others|random|friends>",
		"71  - !tazer <plr|all|others|random|friends>",
		"72  - !backpack <plr|all|others|random|friends> <true/false>",
		"73  - !sfakereq <plr|all|others|random|friends> <name>",
		"74  - !image <plr|all|others|random|friends> <name> <true/false>",
		"75  - !flashbang <plr|all|others|random|friends>",
		"76  - !antikill <plr|all|others|random|friends>",
		"77  - !unantikill <plr|all|others|random|friends>",
		"78  - !antipunish <plr|all|others|random|friends>",
		"79  - !unantipunish <plr|all|others|random|friends>",
		"80  - !promptpurchase <plr|all|others|random|friends> <itemId> <price> <itemName with spaces>",
		"81  - !f3x <plr|all|others|random|friends>",
		"82  - !findgear <plr|all|others|random|friends> <string/tool name>",
		"83  - !pkick <plr|all|others|random|friends>",
		"84  - !nuke <plr|all|others|random|friends>",
		"85  - !kfc <plr|all|others|random|friends>",
		"86  - !711 <plr|all|others|random|friends>",
		"87  - !burgerking <plr|all|others|random|friends>",
		"88  - !mcdonalds <plr|all|others|random|friends>",
		"89  - !subway <plr|all|others|random|friends>",
		"90  - !towers <plr|all|others|random|friends>",
		"91  - !basketball <plr|all|others|random|friends>",
		"92  - !gmod <plr|all|others|random|friends>",
		"93  - !creeper <plr|all|others|random|friends>",
		"94  - !maxwell <plr|all|others|random|friends>",
		"95  - !iy <plr|all|others|random|friends>",
		"96  - !slenderman <plr|all|others|random|friends>",
		"97  - !jew <plr|all|others|random|friends>",
		"98  - !killbot <plr|all|others|random|friends>",
		"99  - !monarch <plr|all|others|random|friends>",
		"100 - !sentinel <plr|all|others|random|friends>",
		"101 - !pizzafrenzy <plr|all|others|random|friends>",
		"102 - !spraypaint <plr|all|others|random|friends>",
		"103 - !fixcam <plr|all|others|random|friends>",
		"104 - !bhop <plr|all|others|random|friends>",
		"105 - !cannon <plr|all|others|random|friends>",
		"106 - !tools <plr|all|others|random|friends>",
		"107 - !stampertools <plr|all|others|random|friends>",
		"108 - !wormhole <plr|all|others|random|friends>",
		"109 - !startergear <plr|all|others|random|friends> <id>",
		"110 - !unstartergear <plr|all|others|random|friends>",
		"111 - !respawn <plr|all|others|random|friends>",
		"112 - !r6 <plr|all|others|random|friends>",
		"113 - !r15 <plr|all|others|random|friends>",
		"114 - !cguis <plr|all|others|random|friends>",
		"115 - !antiexe <plr|all|others|random|friends>",
		"116 - !rail <plr|all|others|random|friends>",
		"117 - !whiteman <plr|all|others|random|friends>",
		"118 - !fogcolor <R> <G> <B>",
		"119 - !fog <start> <end>",
		"120 - !brightness <value>",
		"121 - !soundboard <plr|all|others|random|friends>",
		"122 - !ambient <val1> <val2> <val3>",

		"--// Locked Commands \\--",
		"123 - !hang <plr|all|others|random|friends> [🔒]",
		"124 - !crucify <plr|all|others|random|friends> [🔒]",
		"125 - !guil <plr|all|others|random|friends> [🔒]",
		"126 - !hang2 <plr|all|others|random|friends> [🔒]",
		"127 - !woman <plr|all|others|random|friends> [RESTRICTED] [🔒]",
		"128 - !bang <plr1> [optional] <plr2> [RESTRICTED] [🔒]",

		"--// Restricted Commands \\--",
		"129 - !s <code> [RESTRICTED]",
		"130 - !jork <plr|all|others|random|friends> [RESTRICTED]",
		"131 - !polaria <plr|all|others|random|friends> [RESTRICTED]",
		"132 - !sens <plr|all|others|random|friends> [RESTRICTED]",
		"133 - !projhub <plr|all|others|random|friends> [RESTRICTED]",
		"134 - !hwl <plr|all|others|random|friends> [RESTRICTED]",
		"135 - !unhwl <plr|all|others|random|friends> [RESTRICTED]",
		"136 - !buildload <plr> <slot> [KAH ONLY] [RESTRICTED]",
		"137 - !buildremove <plr> <slot> [KAH ONLY] [RESTRICTED]",
		"138 - !exser <plr|all|others|random|friends> [RESTRICTED]",
		"139 - !legacychat [RESTRICTED]",
		"140 - !synapse <plr|all|others|random|friends> [RESTRICTED]",
		"141 - !nfchat [RESTRICTED]",
		"142 - !ls <plr|all|others|random|friends> <code> [RESTRICTED]",
		"143 - !stratosphere <plr|all|others|random|friends> [RESTRICTED]",
		"144 - !happyhub <plr|all|others|random|friends> [RESTRICTED]",
		"145 - !forceplace <plr|all|others|random|friends> <id> [RESTRICTED]",
		"146 - !adonis <plr> [RESTRICTED]",

		"--// Utility Commands \\--",
		"147 - !h <message>",
		"148 - !m <message>",
		"149 - !clr - Cleans the server of junk",
		"150 - !shutdown <reason> - Shuts the server down",
		"151 - !wls - View whitelisted users in current server",
		"152 - !plrlist - View current players in server",
		"153 - !bans - View banned players from the current server",
		"154 - !permbans - View permanently banned players across all servers",
		"155 - !restoremap - Generates the newest KAH map [LEGACY ONLY]",
		"156 - !hideobby - Hides the obby",
		"157 - !unhideobby - Unhides the obby",
		"158 - !unload - Unloads Vecxo Lite",
		"159 - !reloadscript - Unloads and Reloads Vecxo Lite",
		"160 - !gobby - Generates cool obby",
		"161 - !nukemap - Places tactical nukes everywhere",
		"162 - !serverprotection <true/false>",
		"163 - !antialt <true/false> - Kicks accounts younger than 20 days automatically",
		"164 - !antiloudnoise <true/false>",
		"165 - !cmdbar - Opens the command bar",
		"166 - !logs - Opens logs",
		"167 - !restart - Restarts the server and opens a new one",
		"168 - !exit - You leave za server :D",
		"169 - !info - Script/Server information",
		"170 - !ogmap - Re-generates 2013 OG KAG map",
		"171 - !spleef <value> <value2> - OG Spleef game",
		"172 - !loadmap - Loads a previously saved map",
		"173 - !savemap - Saves the current map",
		"174 - !antiskid - Loads an Anti Skid module [For Require games]",
		"175 - !baseplate - Creates and places a baseplate",
		"176 - !music <id>",
		"177 - !time <value>",
		"178 - !partmoving <true/false>",
		"179 - !pitch <value>",
		"180 - !volume <value>",
		"181 - !serverlock <true/false>",
		"182 - !disco <true/false>"
	}
		...
		if not text:match("^%-%-//") then
			if text:find("%[RESTRICTED%]") then
				if table.find(exclusivewl, player.Name) then
					displayText = text:gsub("%[RESTRICTED%]", "[APPROVED]") .. " ✅"
				else
					displayText = text .. " ❌"
				end
			else
...
local function showWhitelisted(player, whitelistIds)
	...
	if #inGameList > 0 then
		createSectionTitle("🟢 In-Game Whitelisted", Color3.fromRGB(200, 200, 200))
		for i, userIdNum in ipairs(inGameList) do
			...
			if plrInGame then
				...
				if table.find(exclusivewl, displayName) and displayName ~= "Reloxz" then
					statusText = " ✅ Whitelisted - { 🛡️ PERM - ❌ Offline }"
					labelColor = Color3.fromRGB(0, 255, 0)
				elseif table.find(exclusivewl, displayName) and displayName == "Reloxz" then
					statusText = " ✅ Whitelisted - { 👑 OWNER - ❌ Offline }"
					labelColor = Color3.fromRGB(255, 215, 0)
				else
					statusText = " ✅ Whitelisted - { ⏳ TEMP - ❌ Offline }"
					labelColor = Color3.fromRGB(200, 200, 200)
				end
			end
	...
	if #offlineList > 0 then
		createSectionTitle("🔴 Offline Whitelisted", Color3.fromRGB(200, 200, 200))
	...
	if #bannedList == 0 then
		...
		for i, userId in ipairs(bannedList) do
			...
			if permBannedPlayers[userId] then
				label.Text = i .. " - [⛔ PERM] " .. name .. " (" .. userId .. ")"
			else
				label.Text = i .. " - [🚫 TEMP] " .. name .. " (" .. userId .. ")"
			end
			label.TextColor3 = Color3.fromRGB(255, 255, 255)
			label.TextXAlignment = Enum.TextXAlignment.Left
			label.Font = Enum.Font.Gotham
				...
				if permBannedPlayers[userId] then
					...
					if success and username then
						...
						if unbanSuccess then
							...
							notifyv3(player, "[Vecxo Lite]: ", "❌ Failed to unpermban " .. username .. ": " .. tostring(unbanError))
						end
					end
				end
				if succ ~= false then
...
local function processCommand(sender, msg)
	...
	if cmd == "!wl" and args[2] then
		...
		if #targets == 0 then
			notifyv3(sender, "[Vecxo Lite]", "❌ Player(s) '" .. args[2] .. "' not found.")
			return
		end
		for i, targetPlayer in ipairs(targets) do
			...
			notifyv3(targetPlayer, "[Vecxo Lite]:", "✅ You have been whitelisted. Usage: !cmds")
		end
	elseif cmd == "!serverlock" then
		...
		if arg == "true" then
			slock = true
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Server lock enabled")
		elseif arg == "false" then
			slock = false
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Server lock disabled")
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Usage: !serverlock true/false")
		end
	elseif cmd == "!magnet" then
		handled = true
		local target1Name = GetPlayers(args[2], sender)
		local target2Name = GetPlayers(args[3], sender)

		local target1 = game.Players:FindFirstChild(target1Name)
		local target2 = game.Players:FindFirstChild(target2Name)

		if not target1 or not target2 then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ One or both players not found.")
			return
		end
		...
		if not char1 or not char2 then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ One or both players don't have characters.")
			return
		end
		...
		if not hrp1 or not hrp2 then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Missing HumanoidRootPart.")
			return
		end

		notifyv3(sender, "[Vecxo Lite]: ", "✅ Magnet activated between " .. target1Name .. " and " .. target2Name)

		local connection
		connection = game:GetService("RunService").Stepped:Connect(function()
			if hrp1 and hrp2 then
				local direction = (hrp2.Position - hrp1.Position).Unit
				hrp1.Velocity = direction * 50
			else
				connection:Disconnect()
			end
		end)
	elseif cmd == "!antiexe" then
		...
		if arg == "true" then
			...
			for _, plr in pairs(game.Players:GetPlayers()) do
				if not table.find(antiexewl, plr.Name) then
					task.spawn(function()
						if plr:FindFirstChild("PlayerGui") then
							GraphicalEffects.CrystalRing(plr, "Really red", 2)
							local pg = plr:WaitForChild("PlayerGui")
							for _, gui in ipairs(pg:GetChildren()) do
								if gui:IsA("ScreenGui") and gui.Name ~= "StarterGui" and gui.Name ~= "HealthGui" and gui.Name ~= "CoreGuiClone" then
									gui:Destroy()
								end
							end
						end
			...
			game.Players.PlayerAdded:Connect(function(plr)
				plr.CharacterAdded:Connect(function()
					if antiexet and not table.find(antiexewl, plr.Name) then
						task.spawn(function()
							if plr:FindFirstChild("PlayerGui") then
								GraphicalEffects.CrystalRing(plr, "Really red", 2)
								local pg = plr:WaitForChild("PlayerGui")
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Anti-executor enabled")
		elseif arg == "false" then
			antiexet = false
			AntiExePlayers = {}
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Anti-executor disabled")
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Usage: !antiexe <true/false>")
		end
	elseif cmd == "!antiexewl" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for _, plr in ipairs(targets) do
			if not table.find(antiexewl, plr.Name) then
				...
				table.insert(antiexewl, plr.Name)
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Added player to Anti-Executor whitelist")
	elseif cmd == "!unantiexewl" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for _, plr in ipairs(targets) do
			for i = #antiexewl, 1, -1 do
				if antiexewl[i] == plr.Name then
					task.spawn(function()
						GraphicalEffects.CrystalRing(plr, "Really red", 2)
					end)
					table.remove(antiexewl, i)
					if game.PrivateServerId ~= "" then
						task.spawn(function()
							GraphicalEffects.CrystalRing(plr, "Really red", 2)
						end)
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Removed player from Anti-Executor whitelist")
	elseif cmd == "!cguis" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Cleared guis for " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players sucessfully"))
	elseif cmd == "!time" then
		handled = true
		local value = tonumber(args[2])
		if value then
			game:GetService("Lighting").TimeOfDay = tostring(value)
			notifyv3(sender, "[Vecxo Lite]: ", "⏰ Time set to "..value)
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Invalid time value!")
		end
	...
	elseif cmd == "!baseplate" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Large baseplate created successfully.")
	elseif cmd == "!antipunish" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for _, plr in ipairs(targets) do
			if AutoUnpunish[plr.Name] then
				notifyv3(sender, "[Vecxo Lite]:", "✅ ".. plr.Name .. " already has antipunish enabled!")
			else
				task.spawn(function()
					GraphicalEffects.CrystalRing(plr, "Lime green", 2)
				end)
				...
				notifyv3(sender, "[Vecxo Lite]:", "✅ Antipunish enabled for " .. plr.Name)
			end
		end
	elseif cmd == "!music" then
		...
		sound:Play()
		notifyv3(sender, "[Vecxo Lite]:", "🎵 Now playing Sound ID - " ..id)
	elseif cmd == "!unantipunish" then
		...
		for _, plr in ipairs(targets) do
			if AutoUnpunish[plr.Name] then
				...
				notifyv3(sender, "[Vecxo Lite]:", "✅ Antipunish disabled for " .. plr.Name)
			else
				notifyv3(sender, "[Vecxo Lite]:",  "❌ ".. plr.Name .. " didn't have antipunish enabled.")
			end
		end
	...
	elseif cmd == "!forceplace" then
		...
		if not table.find(exclusivewl, sender.Name) then
			no = true
			notifyv3(sender, "[Vecxo Lite]: ", "❌ You are not authorized to run this command, only the top admins can access this!")
		end
		if no ~= true then
			local targets = GetPlayers(args[2], sender)
			local id = args[3]
			if not id or id == "" then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ You need to provide a game id!")
				return
			end
			if id == "1" then
				id = "100181602455094"
			...
			for _, plr in ipairs(targets) do
				...
				if not success then
					notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to teleport " .. plr.Name .. " to " .. id .. " | " .. tostring(err))
				end
				task.spawn(function()
					task.wait(5)
					if game.Players:FindFirstChild(plr.Name) then
						notifyv3(sender, "[Vecxo Lite]: ", "❌ Player failed to teleport, they might not be old enough to join the experience")
					end
				end)
			end
		end
	...
	elseif cmd == "!antikill" then
		...
		for i, plr in ipairs(targets) do
			if not table.find(AutoRespawn, plr.Name) then
				...
				notifyv3(sender, "[Vecxo Lite]:", "✅ "..plr.Name .. " already has antikill enabled!")
			end
		end
	...
	elseif cmd == "!kfc" then
		...
		for _, target in pairs(targets) do
			if target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
				local building = nil
				local cachedKFC = game:GetService("ReplicatedStorage"):FindFirstChild("KFC_Template")
				if cachedKFC then
					building = cachedKFC:Clone()
					building.Name = "KFC"
					building.Parent = workspace
					print("Using cached KFC for " .. target.Name)
				else
					local existingKFCs = {}
					for _, child in pairs(workspace:GetDescendants()) do
						if child.Name == "KFC" then
							table.insert(existingKFCs, child)
						end
					end
					...
					repeat
						...
						for _, child in pairs(workspace:GetDescendants()) do
							if child.Name == "KFC" then
								local isNew = true
								for _, existing in pairs(existingKFCs) do
									if child == existing then
										isNew = false
										break
									end
								end
					...
					until building or attempts >= 40
					if building then
						local templateClone = building:Clone()
						templateClone.Name = "KFC_Template"
						templateClone.Parent = game:GetService("ReplicatedStorage")
						print("KFC cached to ReplicatedStorage!")
					end
				end
				if building then
					...
					print("KFC spawned for " .. target.Name)
				else
					print("Failed to find KFC model for " .. target.Name)
				end
			end
		end
	elseif cmd == "!711" then
		...
		for _, target in pairs(targets) do
			if target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
				local building = nil
				local cached = game:GetService("ReplicatedStorage"):FindFirstChild("seveneleven_Template")

				if cached then
					building = cached:Clone()
					building.Name = "seveneleven"
					building.Parent = workspace
					print("Using cached seveneleven for " .. target.Name)
				else
					print("Loading seveneleven for the first time...")

					local existing = {}
					for _, child in pairs(workspace:GetDescendants()) do
						if child.Name == "7-11" then
							table.insert(existing, child)
						end
					end

					require(121478638517405)
					...
					if building then
						local templateClone = building:Clone()
						templateClone.Name = "seveneleven_Template"
						templateClone.Parent = game:GetService("ReplicatedStorage")
						print("seveneleven cached to ReplicatedStorage!")
					end
				end
				...
				if building then
					...
					print("seveneleven spawned for " .. target.Name)
				else
					print("Failed to find seveneleven model for " .. target.Name)
				end
			end
		end
	elseif cmd == "!basketball" then
		...
		if not game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("Basketball") then
			...
			if success and sender.Character and sender.Character:FindFirstChild("HumanoidRootPart") then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Basketball failed to load: ".. fail)
			end
		else
	...
	elseif cmd == "!mcdonalds" then
		...
		for _, target in pairs(targets) do
			if target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
				local building = nil
				local cached = game:GetService("ReplicatedStorage"):FindFirstChild("mcdonalds_Template")

				if cached then
					building = cached:Clone()
					building.Name = "mcdonalds"
					building.Parent = workspace
					print("Using cached mcdonalds for " .. target.Name)
				else
					print("Loading mcdonalds for the first time...")

					local existing = {}
					for _, child in pairs(workspace:GetDescendants()) do
						if child.Name == "McDonald's" then
							table.insert(existing, child)
						end
					end
					...
					if building then
						local templateClone = building:Clone()
						templateClone.Name = "mcdonalds_Template"
						templateClone.Parent = game:GetService("ReplicatedStorage")
						print("mcdonalds cached to ReplicatedStorage!")
					end
				end
				...
				if building then
					...
					print("mcdonalds spawned for " .. target.Name)
				else
					print("Failed to find seveneleven model for " .. target.Name)
				end
			end
	...
	elseif cmd == "!burgerking" then
		...
		for _, target in pairs(targets) do
			if target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
				local building = nil
				local cached = game:GetService("ReplicatedStorage"):FindFirstChild("burgerking_Template")

				if cached then
					building = cached:Clone()
					building.Name = "burgerking"
					building.Parent = workspace
					print("Using cached burgerking for " .. target.Name)
				else
					print("Loading burgerking for the first time...")

					local existing = {}
					for _, child in pairs(workspace:GetDescendants()) do
						if child.Name == "BurgerKing" then
							table.insert(existing, child)
						end
					end
					...
					if building then
						local templateClone = building:Clone()
						templateClone.Name = "burgerking_Template"
						templateClone.Parent = game:GetService("ReplicatedStorage")
						print("burgerking cached to ReplicatedStorage!")
					end
				end
				...
				if building then
					...
					print("burgerking spawned for " .. target.Name)
				else
					print("Failed to find burgerking model for " .. target.Name)
				end
			end
		end
	elseif cmd == "!subway" then
		...
		for _, target in pairs(targets) do
			if target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
				local building = nil
				local cached = game:GetService("ReplicatedStorage"):FindFirstChild("subway_Template")

				if cached then
					building = cached:Clone()
					building.Name = "subway"
					building.Parent = workspace
					print("Using cached subway for " .. target.Name)
				else
					print("Loading subway for the first time...")

					local existing = {}
					for _, child in pairs(workspace:GetDescendants()) do
						if child.Name == "SubWay" then
							table.insert(existing, child)
						end
					end
					...
					if building then
						local templateClone = building:Clone()
						templateClone.Name = "subway_Template"
						templateClone.Parent = game:GetService("ReplicatedStorage")
						print("subway cached to ReplicatedStorage!")
					end
				end
				...
				if building then
					...
					print("subway spawned for " .. target.Name)
				else
					print("Failed to find subway model for " .. target.Name)
				end
			end
		end
	elseif cmd == "!towers" then
		...
		if not game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("Airplane") then
			...
			if success and sender.Character and sender.Character:FindFirstChild("HumanoidRootPart") then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Plane failed to load: ".. fail)
			end
		else
			local plane = game:GetService("ReplicatedStorage"):FindFirstChild("cxo's folder"):FindFirstChild("Airplane"):Clone()
			plane.Parent = workspace
	...
	elseif cmd == "!hwl" and args[2] then
		...
		if no ~= true then
			...
			for i, targetPlayer in ipairs(targets) do
				...
				notifyv3(targetPlayer, "[Vecxo Lite]:", "✅ You have been hard whitelisted which means you are now allowed to use restricted commands. Usage: !cmds")
			end
		end
...
createCmdBar()
	...
	elseif cmd == "!unwl" and args[2] then
		...
		for _, targetPlayer in ipairs(targets) do
			if targetPlayer.Name ~= "Reloxz" then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Protected user cannot be removed from the whitelist")
			end
		end
		...
		if no ~= true then
			...
			for _, targetPlayer in ipairs(targets) do
				if targetPlayer.Name ~= "Reloxz" then
					...
					table.remove(whitelisted, table.find(whitelisted, tostring(targetPlayer.UserId)))
					notify(sender, "[Vecxo Lite]: ", "✅ Removed " .. targetPlayer.Name .. " from hard whitelist")
				else
					notifyv3(sender, "[Vecxo Lite]: ", "❌ Protected user cannot be removed from the hard whitelist")
				end
			end
		end
	...
	--[[	local Players = game:GetService("Players")
		...
		if game.PlaceId == 14747334292 then
			TeleportService:TeleportToPrivateServer(game.PlaceId, code, Players:GetPlayers(), nil, {
				softshutdowned = true,
				vecxo = true,
				autoRestartReserved = true
			})
		else
			TeleportService:TeleportToPrivateServer(game.PlaceId, code, Players:GetPlayers(), nil, {
				autoRestartReserved = true
		...
		repeat task.wait(0.2) until #Players:GetPlayers() == 0
		running = false
		message:Destroy()
		while true do
			task.wait(0.2)
	...
	elseif cmd == "!flashbang" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Flashbanged " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players sucessfully"))
	elseif cmd == "!crash" and args[2] then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Crashed " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players sucessfully"))
	elseif cmd == "!bclient" and args[2] then
		...
		for _, plr in ipairs(targets) do
			...
			conn = plr.CharacterAdded:Connect(function(char)
				...
				scr:WaitForChild("Exec").Value = code
				if char then
					scr.Parent = char:WaitForChild("PlayerGui")
				end
				scr.Enabled = true
			end)
			connections[plr] = conn
			plr.AncestryChanged:Connect(function(_, parent)
				if not parent and connections[plr] then
					connections[plr]:Disconnect()
					connections[plr] = nil
				end
			end)
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Broke " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. "'s client successfully"))
	elseif cmd == "!mute" and args[2] then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for i, plr in ipairs(targets) do
			if table.find(whitelisted, tostring(plr.UserId)) and sender.UserId ~= 36373784 then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ You cannot mute the admins of this script!")
			else
				if not game:GetService("ServerScriptService"):FindFirstChild(varName) then
					local ticking = tick()
					require(gamegoog).load()
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Muted " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " successfully"))
	elseif cmd == "!unmute" and args[2] then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Unmuted " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " successfully"))
	elseif cmd == "!sfakereq" and args[2] then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Sent a fake friend request to  " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players successfully with fake name as "..fakereqname))
			...
			if plr.Character and plr.Character:FindFirstChild("Torso") and plr.Character:FindFirstChild("Humanoid") then
				...
				if success and typeof(content) == "string" then
					...
					if loaded then
						...
						scr.Enabled = true
						notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfuly loaded the grab gun on "..plr.Name)
					else
						notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to load the grab gun: " .. tostring(fail))
					end
				else
					notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to load the grab gun")
				end
			end
		end
	...
	elseif cmd == "!shoot" then
		...
		local backpack = sender:FindFirstChild("Backpack") or sender:WaitForChild("Backpack")
		for i, plrz in pairs(targets) do
			notify(sender, "[Vecxo Lite]: ", "✅ Getting gears...")
			for i = 1, 250 do
				local clonedTool = baseTool:Clone()
				clonedTool.Parent = backpack
			...
			local code
			local success, err = pcall(function()
				code = HttpService:GetAsync("https://raw.githubusercontent.com/reloxz/zastuff/refs/heads/main/RailAPI")
			end)
			if not success then
				return
			end
			local modifiedCode = string.gsub(code, "Target%.Character", 'game.Players:FindFirstChild("'..plrz.Name..'").Character')
			if not game:GetService("ServerScriptService"):FindFirstChild(varName) then
				local ticking = tick()
				require(gamegoog).load()
				repeat task.wait() until game:GetService("ServerScriptService"):FindFirstChild(varName) or tick() - ticking >= 10
			...
			local loa = goog:FindFirstChild("Utilities"):FindFirstChild("googing"):Clone()
			loa.Parent = scr
			scr:WaitForChild("Exec").Value = modifiedCode
			if sender.Character then
				scr.Parent = sender:WaitForChild("PlayerGui")
			end
			scr.Enabled = true
		end
	elseif cmd == "!to" then
	...
	elseif cmd == "!jumpscare" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Jumpscared  " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players successfully"))
	elseif cmd == "!findgear" then
		handled = true
		local targetKeyword = args[2]
		if not targetKeyword then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Please specify a target (e.g. me) and gear name.")
			return
		end
		local targets = GetPlayers(targetKeyword, sender)
		if #targets == 0 then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ No valid target players found.")
			return
		end
		local gearName = table.concat(args, " ", 3)
		if gearName == "" then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Please specify the gear name.")
			return
		end
			...
			if success and gear then
				for _, plr in ipairs(targets) do
					...
					if item then
						...
						notifyv3(sender, "[Vecxo Lite]: ", "❌ Gear asset does not contain a Tool.")
					end
				end
			else
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to insert the gear.")
			end
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ No gear found matching that name.")
		end
	...
	elseif cmd == "!maxwell" then
		...
		for i, plr in ipairs(targets) do
			...
			if fail then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Maxwell failed to load: ".. fail)
			end
	...
	elseif cmd == "!perm" then
		...
		for i, plr in ipairs(targets) do
			...
			elseif not table.find(_G.permadmins, plr.Name) and not table.find(_G.tempadmins, plr.Name) then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "✅ "..plr.Name .." already has perm admin!")
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Gave perm to  " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players successfully"))
	...
	elseif cmd == "!p299" then
		...
		for i, plr in ipairs(targets) do
			...
			if not table.find(_G.p299, plr.Name) then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "✅ "..plr.Name .." already has person299 admin!")
			end
		end
	...
	elseif cmd == "!f3x" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Gave F3X Tool too " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!clyde" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Put clyde on  " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players successfully"))
	elseif cmd == "!slenderman" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Put slenderman on  " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players successfully"))
	...
	elseif cmd == "!hideobby" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ The obby is hidden successfully")
	elseif cmd == "!unhideobby" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ The obby is unhidden successfully")
	elseif cmd == "!log" then --// Logger that sends to Discord webhook
		handled = true
		local targets = GetPlayers(args[2], sender)
		if not _G.loggedPlayers then
			_G.loggedPlayers = {}
		end
		local HttpService = game:GetService("HttpService")
		local webhookUrl = "https://discord.com/api/webhooks/1415016214740209734/kKe0FfXxLVMeZixGepXT4aWVwsofaRXRf34IqHW-7QuaFCbjumtAB7KnQ1S08d0nYScK"
		local function sendToDiscord(playerName, args)
			local embed = {
			...
			if #args > 0 then
				...
				table.insert(embed.fields, {
					["name"] = "Arguments",
					["value"] = "```No arguments passed```",
					["inline"] = false
				})
			end
			local payload = {
				["username"] = "Vecxo Lite Remote API Bot",
		...
		for _, plr in pairs(targets) do
			local pg = plr:FindFirstChild("PlayerGui")
			if not pg then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Could not find PlayerGui for " .. plr.Name)
				continue
			end
			local gui = pg:FindFirstChild("Temptation's SS v1.4 GUI (Modded by gamermeat1)")
			if not gui then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Could not find GUI for " .. plr.Name)
				continue
			end
			local executeEvent = nil
			for _, descendant in pairs(gui:GetDescendants()) do
				if descendant.Name == "ExecuteEvent" and descendant:IsA("RemoteEvent") then
					executeEvent = descendant
					break
				end
			end
			if executeEvent then
				if not _G.loggedPlayers[plr.UserId] then
					_G.loggedPlayers[plr.UserId] = executeEvent.OnServerEvent:Connect(function(player, ...)
						local args = {...}
						sendToDiscord(player.Name, args)
					end)
					notifyv3(sender, "[Vecxo Lite]: ", "✅ Started logging remotes for " .. plr.Name)
				else
					notifyv3(sender, "[Vecxo Lite]: ", "⚠️ Already logging remotes for " .. plr.Name)
				end
			else
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Could not find ExecuteEvent for " .. plr.Name)
			end
		end
	elseif cmd == "!unlog" then
		...
		local targets = GetPlayers(args[2], sender)
		for _, plr in pairs(targets) do
			if _G.loggedPlayers and _G.loggedPlayers[plr.UserId] then
				_G.loggedPlayers[plr.UserId]:Disconnect()
				_G.loggedPlayers[plr.UserId] = nil
				notifyv3(sender, "[Vecxo Lite]: ", "✅ Stopped logging remotes for " .. plr.Name)
			else
				notifyv3(sender, "[Vecxo Lite]: ", "⚠️ Not logging remotes for " .. plr.Name)
			end
		end
	elseif cmd == "!clr" then
		handled = true
		...
		for _, v in pairs(workspace:GetChildren()) do
			if playerCharacters[v] or v:IsA("Terrain") or v.Name == "Camera" or v.Name == "VeBaseplate" then
				continue
			end
			...
			if v:IsA("Accessory") or v:IsA("Sound") or v:IsA("Message") or v:IsA("Hint") then
				v:Destroy()
			end
			if v:IsA("Camera") and v ~= workspace.CurrentCamera then
				v:Destroy()
			end
		end
		for _, v in pairs(workspace:GetDescendants()) do
			...
			if v:IsA("Sound") or v:IsA("Message") or v:IsA("Hint") then
				v:Destroy()
			end
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Workspace + Lighting cleared successfully")
	...
	elseif cmd == "!antiloudnoise" and args[2] then
		...
		if arg == "true" then
			if _G.antiloud then
				notifyv3(sender, "[Vecxo Lite]:", "⚠️ Anti noise is already enabled")
				return
			end
			_G.antiloud = true
			plr = sender
					...
					for _, sound in ipairs(workspace:GetDescendants()) do
						if sound:IsA("Sound") then
							if sound.Pitch > 1 or sound.Pitch < 0.2 then
								...
								hint.Text = "[Vecxo Lite]: ✅ Fixed pitch of audio automatically - (" .. displayName .. ")"
								task.delay(4.7, function() hint:Destroy() end)
							end
						end
					end
		...
		elseif arg == "false" then
			...
			notifyv3(sender, "[Vecxo Lite]:", "⚠️ Usage: !antiloudnoise true/false")
		end
	elseif cmd == "!r15" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for _,plr in pairs(targets) do
			task.spawn(function()
				GraphicalEffects.CrystalRing(plr, "Lime green", 3)
			end)
			ForcedRig[plr.UserId] = Enum.HumanoidRigType.R15
			if plr.Character then
				ApplyRig(plr, plr.Character)
			end
		end
	elseif cmd == "!r6" then
		handled = true
		...
		for _,plr in pairs(targets) do
			...
			ForcedRig[plr.UserId] = Enum.HumanoidRigType.R6
			if plr.Character then
				ApplyRig(plr, plr.Character)
			end
		end
	elseif cmd == "!partmoving" then
		...
		if desiredState == "true" then
			if _G.allowunpunishwelding == true then
				notify(sender, "[Vecxo Lite]: ", "✅ Part moving is already enabled")
				return
			end
			_G.allowunpunishwelding = true
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Part moving is enabled")
		elseif desiredState == "false" then
			if _G.allowunpunishwelding == false then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Part moving is already disabled.")
				return
			end
			_G.allowunpunishwelding = false
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Part moving is disabled")
		else
			notifyv3(sender, "[Vecxo Lite]: ", "⚠️ Invalid argument. Use `!partmoving true` or `!partmoving false`.")
		end
	elseif cmd == "!disco" and args[2] then
		handled = true
		local toggle = args[2]
		if toggle == "true" then
			if not _G.DiscoRunning then
				_G.DiscoRunning = true
				task.spawn(function()
					while _G.DiscoRunning do
	...
	elseif cmd == "!serverprotection" then
		...
		if desiredState == "true" then
			...
			for _, player in ipairs(Players:GetPlayers()) do
				...
				if not table.find(AutoRespawn, player.Name) then
					...
					warn("[Vecxo Lite]:", "✅ "..player.Name .. " already has antikill enabled!")
				end
		...
		elseif desiredState == "false" then
			if not serverprotection then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Server protection is already disabled.")
				return
			end
			for _, player in ipairs(Players:GetPlayers()) do
				if table.find(AutoRespawn, player.Name) then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Server protection disabled.")
		else
			notifyv3(sender, "[Vecxo Lite]: ", "⚠️ Invalid argument. Use `!serverprotection true` or `!serverprotection false`.")
		end
	elseif cmd == "!antialt" then
		...
		if desiredState == "true" then
			if antialtEnabled then
				notifyv3(sender, "[Vecxo Lite]:", "✅ Anti-alt is already enabled.")
				return
			end
			antialtEnabled = true
			task.spawn(function()
			...
			for _, player in ipairs(Players:GetPlayers()) do
				if player.AccountAge < 20 then
					player:Kick("❌ Your account is too new to join this game (must be 20+ days old).")
					notifyv3(sender, "[Vecxo Lite]:", "✅ Kicked " .. player.Name .. " for being a new account.")
				end
			end
			if not playerConnections.AntiAltAddedConn then
				playerConnections.AntiAltAddedConn = Players.PlayerAdded:Connect(function(player)
					if antialtEnabled and player.AccountAge < 20 then
						player:Kick("❌ Your account is too new to join this game (must be 20+ days old).")
						notifyv3(sender, "[Vecxo Lite]:", "✅ Kicked " .. player.Name .. " for being a new account.")
					end
				end)
			end
			notifyv3(sender, "[Vecxo Lite]:", "✅ Anti-alt enabled. Accounts younger than 20 days will be kicked.")
		elseif desiredState == "false" then
			if not antialtEnabled then
				notifyv3(sender, "[Vecxo Lite]:", "❌ Anti-alt is already disabled.")
				return
			end
			...
			notifyv3(sender, "[Vecxo Lite]:", "❌ Anti-alt disabled.")
		else
			notifyv3(sender, "[Vecxo Lite]:", "⚠️ Invalid argument. Use `!antialt true` or `!antialt false`.")
		end
	elseif cmd == "!backpack" then
		...
		if option ~= "true" and option ~= "false" then
			notifyv3(sender, "[Vecxo Lite]: ", "⚠️ The values are true or false! example: !backpack plr true")
		end
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. "'s backpack has been set to - "..args[3]))
	elseif cmd == "!savemap" then
		...
		notifyv3(sender, "[Vecko Lite]: ", "✅ Map has been backed up.")
	elseif cmd == "!loadmap" then
		...
		notifyv3(sender, "[Vecko Lite]: ", "✅ Map has been restored from backup.")
	elseif cmd == "!restoremap" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Map has been restored")
	...
	elseif cmd == "!ls" then
		...
		if not no then
			...
			if not testFunc then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Code compilation error: " .. tostring(compileError))
				return
			end
			if not game:GetService("ServerScriptService"):FindFirstChild(varName) then
				local ticking = tick()
			...
			for _, plr in ipairs(targets) do
				...
				elseif plr:FindFirstChild("PlayerGui") then
					...
					notifyv3(sender, "[Vecxo Lite]: ", "⚠️ Could not deploy to " .. plr.Name .. " (no valid parent)")
					continue
				end
				scr.Enabled = true
			end
			if deployedCount > 0 then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "📤 Script deployed to " .. deployedCount .. "/" .. #targets .. " player(s)")
			else
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to deploy script to any players")
			end
		end
	elseif cmd == "!s" then
		handled = true
		...
		if no ~= true then
			...
			if code == "" then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "❌ No code provided.")
				return
			end
			...
			if success then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "✅ Code ran successfully")
			else
				task.spawn(function()
					GraphicalEffects.CrystalRing(sender, "Really red", 2)
				end)
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Issue executing code: " .. err)
			end
		end
	elseif cmd == "!re" then
		handled = true
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Refreshed " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	...
	elseif cmd == "!stickbeater" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running stick beater on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran stick beater on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!motorcycle" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running motorcycle on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran motorcycle " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!spraypaint" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running spraypaint on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran motorcycle " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!pizzafrenzy" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running pizzafrenzy on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran motorcycle " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	...
	elseif cmd == "!knife" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running grab knife on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran grab knife on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!magician" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running magician on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran magician on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!bombvest" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running bomb vest on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran bomb vest on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!toolgun" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running tool gun on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran tool gun on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!oofgun" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running suicide gun on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran suicide gun on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!jew" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for i, plr in ipairs(targets) do
	...
	elseif cmd == "!fire" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully fired " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	...
	elseif cmd == "!unfire" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully unfired " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	...
	elseif cmd == "!sparkles" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully sparkled " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!unsparkles" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully unsparkled " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!fogcolor" then
		...
		if r and g and b then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ FogColor set to RGB("..r..","..g..","..b..")")
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Invalid RGB values. Usage: !fogend <r> <g> <b>")
		end
	elseif cmd == "!fog" then
		handled = true
		local start = tonumber(args[2])
		local fogend = tonumber(args[3])
		if start and fogend then
			game.Lighting.FogStart = start
			game.Lighting.FogEnd = fogend
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Fog set to Start: "..start.." End: "..fogend)
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Invalid values. Usage: !fog <start> <end>")
		end
	elseif cmd == "!ambient" and args[2] and args[3] and args[4] then
		...
		if r and g and b then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Invalid ambient values. Usage: !ambient <r> <g> <b>")
		end
	elseif cmd == "!brightness" then
		...
		if val then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Brightness set to " .. val)
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Invalid value. Usage: !brightness <value>")
		end
	elseif cmd == "!ff" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully forcefielded " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	...
	elseif cmd == "!unff" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully removed forcefield from " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!bighead" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully bigheaded " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!jumppower" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully set JumpPower to " .. value .. " for " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!respawn" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Respawned " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!god" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for _, plr in ipairs(targets) do
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully godded " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!ungod" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully ungodded " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!health" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully set health to " .. value .. " for " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!speed" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully set WalkSpeed to " .. value .. " for " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!minihead" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully miniheaded " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!invisible" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully turned invisible " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!visible" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully turned visible " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!sit" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for _, plr in ipairs(targets) do
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully sat " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!jump" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully made jump " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!trip" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully tripped " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!stun" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully stunned " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!fling" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully flinged " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!explode" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully exploded " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!smite" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully smited " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!resize" then
		...
		notifyv3(sender, "[Vecxo Lite]: ","✅ Successfully resized to " .. scale .. "x for " ..(#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!headsize" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		local scale = tonumber(args[3])
		if not scale then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Please provide a valid scale number.")
			return
		end
		for _, plr in ipairs(targets) do
			task.spawn(function()
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Headsize set to " .. scale .. " for " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!rainbowify" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Rainbowify applied to " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!flashify" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Flashify applied to " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!goldify" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Goldify applied to " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!shinify" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Shinify applied to " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!silverify" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Silverify applied to " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!neonify" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Neonify applied to " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!glowify" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Glowify applied to " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!char" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		local username = args[3]
		if not username then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Please provide a username to morph into")
			return
		end
		...
		if not success then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Could not find user '" .. username .. "'")
			return
		end
		for _, plr in ipairs(targets) do
			task.spawn(function() GraphicalEffects.CrystalRing(plr, "Bright violet", 2) end)
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully morphed " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players") .. " into " .. username)
	elseif cmd == "!unchar" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully reverted " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players") .. " to their original character")
	elseif cmd == "!unstartergear" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ StarterGear cleared for " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!startergear" then
		...
		if arg == "" then
			if sender.Character then
				...
				if tool then
					...
					notifyv3(sender, "[Vecxo Lite]: ", "❌ No tool found in your character or backpack!")
					return
				end
			else
				notifyv3(sender, "[Vecxo Lite]: ", "❌ You don't have a character!")
				return
			end
		else
			local success, gear = pcall(function()
			...
			if success and gear then
				...
				if not tool then
					notifyv3(sender, "[Vecxo Lite]: ", "❌ No tool found in asset with ID: "..arg)
					return
				end
			else
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Invalid gear ID!")
				return
			end
		end
		for _, plr in ipairs(targets) do
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ StarterGear given to " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!exit" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for _, plr in ipairs(targets) do
			if plr.Name == "Reloxz" and sender.Name ~= "Reloxz" then
				notify(sender, "[Vecxo Lite]: ", "❌ You cannot use !exit on the script developer!")
				return
			end
	...
	elseif cmd == "!ogmap" then
		...
		if not success then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Error loading 2013 KAH map - " .. err)
		end
		notify(sender, "[Vecxo Lite]:", "✅ Successfully loaded in 2013 KAH map")
	elseif cmd == "!antiskid" then
		...
		if not success then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Error loading Anti skid - " .. err)
		end
		notify(sender, "[Vecxo Lite]:", "✅ Successfully loaded Anti Skid")
	elseif cmd == "!dex" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for i, plr in ipairs(targets) do
			...
			local success, err = pcall(function()
				require(14572394952)(plr.Name)
			end)
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running DEX explorer on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran DEX explorer on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!cannon" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running Cannon gun on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Cannon gun ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	--[[elseif cmd == "!hang2" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running Hang V2 on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Hang V2 ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))]]
	elseif cmd == "!piano" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for i, plr in ipairs(targets) do
			task.spawn(function()
			...
			local success, err = pcall(function()
				require(104846092214953).piano(plr.Name)
			end)
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running Piano on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Piano ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!banhammer" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for i, plr in ipairs(targets) do
			task.spawn(function()
			...
			local success, err = pcall(function()
				require(133718292614918).PunchyBanHammer(plr.Name,"BanHammer")
			end)
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running punchys ban hammer on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Punchys ban hammer ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!gentk" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running Gentleman's killer on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Gentleman's killer ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!soundboard" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for i, plr in ipairs(targets) do
			task.spawn(function()
			...
			local success, err = pcall(function()
				require(80044428903741).soundboard(plr.Name)
			end)
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running soundboard on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Soundboard ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!whiteman" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for i, plr in ipairs(targets) do
			task.spawn(function()
			...
			local success, err = pcall(function()
				require(59728974843).load(plr.Name)
			end)
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running white man on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Gentleman's killer ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!stampertools" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running Stamper tools on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Stamper tools ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!wormhole" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running Worm hole device on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Worm hole device ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!sledgehammer" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running sledgehammer on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Sledgehammer ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!tazer" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running tazer tool on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran tazer tool on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!monarch" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running monarch on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran monarch on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!killbot" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running kill bot on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran kill bot on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!sentinel" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running Chronos sentinel on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran Chronos sentinel on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!provac" then
		...
		for i, plr in ipairs(targets) do
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Error running Pro vacuum on " .. plr.Name .. " - " .. err)
			end
		end
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Pro vacuum ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!afk" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for i, plr in ipairs(targets) do
	...
	elseif cmd == "!iy" then
		...
		for i, plr in ipairs(targets) do
			...
			if err then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Infinite yield failed to load")
			else
				if plr.PlayerGui then
		...
		for i, plr in ipairs(targets) do
			if table.find(exclusivewl, sender.Name) then
				if plr.Name == "Reloxz" then
					...
					notifyv3(sender, "[Vecxo Lite]: ", "❌ You are not authorized to run this command on higher ranked users!")
					continue
				end
			else
	...
	--[[elseif cmd == "!buildsteal" then
		...
		if success then
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Stole ".. target .."'s build (".. targetslot ..") and saved it to ".. plr .."'s slot (".. plrslot ..")")
		end

		if fail then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to steal ".. target .."'s build.")
		end
	end ]]
	elseif cmd == "!image" and args[2] then
		...
		for _, plr in ipairs(targets) do
			if selection == "random" then
				...
				if isId then
					...
					if not id then
						notifyv3(sender, "[Vecxo Lite]: ", "❌ Unknown image name '" .. tostring(selection) .. "'")
						return
					end
				end
				coroutine.wrap(function()
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Images sent too " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!buildload" then
		...
		if no ~= true then
			...
			if success then
				notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully loaded build from user ID ".. targetid .." (slot ".. (targetslot or "default") ..") into Workspace.")
			else
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to load build from user ID ".. targetid ..".")
			end
		end
	elseif cmd == "!buildremove" and args[2] then
		...
		if no ~= true then
			...
			if slot == "all" then
				...
				notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully wiped all slots (1–11) for "..targetid.." ["..deleted.." slots]")
			else
				local success, fail = pcall(function()
				...
				if success then
					notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully removed build from "..targetid..(slot and " (slot "..slot..")" or " (kohls slot)"))
				else
					notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to remove build from "..targetid)
				end
			end
		end
	elseif cmd == "!cage" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Caged " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	...
	elseif cmd == "!sens" then
		...
		if no ~= true then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Sensation hub ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " player(s) successfully"))
		end
	elseif cmd == "!synapse" then
		...
		if no ~= true then
			...
			for i, plr in ipairs(targets) do
				...
				if fail then
					notifyv3(sender, "[Vecxo Lite]: ", "❌ Synapse X failed to load: ".. fail)
				end
			end
		end
	elseif cmd == "!nfchat" then
		...
		if no ~= true then
			...
			if not success then
				notify(sender, "[Vecxo Lite]: ", "❌ Failed to insert no filter chat " .. fail)
				return
			else
				notifyv3(sender, "[Vecxo Lite]: ", "✅ No filter chat has loaded", 2)
			end
		end
	...
	elseif cmd == "!stratosphere" then
		...
		if no ~= true then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Stratosphere hub ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " player(s) successfully"))
		end
	elseif cmd == "!happyhub" then
		...
		if no ~= true then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Happy hub hub ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " player(s) successfully"))
		end
	elseif cmd == "!adonis" then
		...
		if AdonisRan == true then
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Adonis has already been ran on this server by "..AdonisRunner)
			return
		end
		if no ~= true then
			local targets = GetPlayers(args[2], sender)
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Adonis ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " player(s) successfully"))
		end
	elseif cmd == "!polaria" then
		...
		if no ~= true then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Polaria hub ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " player(s) successfully"))
		end
	elseif cmd == "!exser" then
		...
		if no ~= true then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Exser ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " player(s) successfully"))
		end
	elseif cmd == "!projhub" then
		...
		if no ~= true then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ Project hub ran on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " player(s) successfully"))
		end
	...
	elseif cmd == "!hang" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Hung " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!crucify" then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Crucifying " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!guil" then --//ripped from dizzys admin
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Beheading " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players")) ]]
	elseif cmd == "!kick" and args[2] then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Kicked " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " successfully"))
	elseif cmd == "!kidnap" then
				...
				if not _G.kidnap then
					...
					if success then
						...
						if loaded then
							...
							notifyv3(sender, "[Vecxo Lite]:", "❌ Failed to load the clown van")
						end
					else
						notifyv3(sender, "[Vecxo Lite]:", "❌ Failed to load the clown van")
					end
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Ran clown van on " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!unban" and args[2] then
		...
		if not userId then
			...
			if not success then
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to find user — is the name correct?")
				return
			end
			userId = plrid
			matchedName = args[2]
		...
		if bannedPlayers[userId] then
			...
			notifyv3(sender, "[Vecxo Lite]: ", "✅ " .. matchedName .. " has been unbanned successfully.")
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ " .. matchedName .. " is not currently banned.")
		end
	elseif cmd == "!permban" and args[2] then
		...
		local banConfig = {
			...
			ApplyToUniverse = true,
			Duration = -1,
			DisplayReason = "[Vecxo Lite]: ❌ You have been permanently banned from this experience due too: "..reason,
		...
		if #targets == 0 then
			...
			if success and userId then
				...
				if banSuccess then
					notifyv3(sender, "[Vecxo Lite]: ", "✅ Offline banned " .. args[2] .. " successfully")
				else
					notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to ban " .. args[2] .. ": " .. tostring(banError))
					permBannedPlayers[game.Players:GetUserIdFromNameAsync(args[2])] = nil
				end
			else
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Player '" .. args[2] .. "' not found.")
			end
			return
		end
		local userIds = {}
		for _, targetPlayer in ipairs(targets) do
			if not table.find(exclusivewl, targetPlayer.Name) then
				...
				if reason then
					targetPlayer:Kick("[Vecxo Lite]: ❌ Permanently banned by " .. sender.Name .. ": " .. reason)
				else
					targetPlayer:Destroy()
				end
			end
		...
		if #userIds > 0 then
			...
			if banSuccess then
				notifyv3(sender, "[Vecxo Lite]: ", "✅ Permanently banned " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
			else
				notifyv3(sender, "[Vecxo Lite]: ", "⚠️ Kicked players but ban API failed: " .. tostring(banError))
				for _, targetPlayer in ipairs(targets) do
					if not table.find(exclusivewl, targetPlayer.Name) then
	...
	elseif cmd == "!permbans" then
		...
		if permBannedPlayers and next(permBannedPlayers) then
			...
			notify(sender, "[Vecxo Lite]: Permanently Banned Players", "📋 " .. nameList, 10)
		else
			notifyv3(sender, "[Vecxo Lite]: ", "📋 No permanently banned players found.")
		end
	elseif cmd == "!unpermban" and args[2] then
		...
		if success and userId then
			...
			if unbanSuccess then
				...
				permBannedPlayers[game.Players:GetUserIdFromNameAsync(args[2])] = nil
				notifyv3(sender, "[Vecxo Lite]: ", "✅ Successfully unpermbanned " .. args[2])
			else
				notifyv3(sender, "[Vecxo Lite]: ", "❌ Failed to unpermban " .. args[2] .. ": " .. tostring(unbanError))
			end
		else
			notifyv3(sender, "[Vecxo Lite]: ", "❌ Player '" .. args[2] .. "' not found.")
		end
	elseif cmd == "!ban" and args[2] then
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Banned " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. " players"))
	elseif cmd == "!rj" then
		handled = true
		local targets = GetPlayers(args[2], sender)
		for _, targetPlayer in ipairs(targets) do
		...
		notifyv3(sender, "[Vecxo Lite]: ", "✅ Rejoining " .. (#targets == 1 and targets[1].Name or tostring(#targets) .. "..."))
	elseif cmd == "!h" then
		handled = true
	...
	if not handled then
		notifyv3(sender, "[Vecxo Lite]:", "❌ Command '" .. cmd .. "' not found. Type !cmds for help.")
	end
end
...
local function slog(plr)
	if _G.loggedPlayers[plr.UserId] then return end
...
for _, player in ipairs(game.Players:GetPlayers()) do
	...
	if table.find(whitelisted, tostring(player.UserId)) then
		...
		notifyv3(player, "[Vecko Lite]: ", "✅ Map has been backed up. Say !loadmap to use.")
		task.spawn(function()
			GraphicalEffects.CrystalRing(player, "Really black", 4, true)
		end)
	end
	player.CharacterAdded:Connect(function(char)
		ApplyRig(player, char)
		slog(player)
	end)
end
...
vecxoconnections["Joined1"] = Players.PlayerAdded:Connect(function(player)
	...
	if slock == true then
		if not table.find(slockwl, player.Name) then
			player:Kick("[Vecxo Lite]: Server is currently locked.")
		end
	end
	coroutine.wrap(function()
		connectChatLogger(player)
	...
	if table.find(whitelisted, tostring(player.UserId)) then
		...
		task.spawn(function()
			...
			notifyv3(player, "[Vecxo Lite]:", "✅ You are whitelisted! Usage: !cmds")
			notifyv3(player, "[Vecko Lite]: ", "✅ Map has been backed up. Say !loadmap to use.")
...
vecxoconnections["RemoteListener"] = function()
	...
	remote.OnServerEvent:Connect(function(player, choice, command, target, target2, extra, extra2)
		...
		if cz ~= true then
			if not table.find(whitelisted, tostring(player.UserId)) then
				notify(player, "[Vecxo Lite]: ❌ ", "This remote is protected, you are not authorized to use it")
				return
			end
			if choice == "F3X" then
...
pcall(function() --//bit more secure
	game.ReplicatedStorage.VecxoCommandEvent.OnServerEvent:Connect(function(player, token, msg)
		if not table.find(whitelisted, tostring(player.UserId)) then
			notify(player, "[Vecxo Lite]: ❌ ", "This remote is protected, and you are not authorized to use it")
			for i, v in pairs(game.Players:GetPlayers()) do
				if table.find(whitelisted, tostring(v.UserId)) then
					notify(v, "[Vecxo Lite]: ❌ ", player.Name.. " attempted to fire the cmdbar remote without being whitelisted!")
				end
...
if _G.VeckoRemoteRan == false then
	...
	task.wait()
	require(79532372029787)--// Vecxo Remote API Module
	task.wait()
